...
⚠️FIRST REQUEST MAY TAKE 20 SECONDS⚠️

Job Tracker is a full‑stack web application built with React on the frontend and Express/Node.js + PostgresSQL on the backend. This app lets a user track their job applications, add new applications, view all applications, edit details and delete them using a custom API backend and a responsive React user interface.
